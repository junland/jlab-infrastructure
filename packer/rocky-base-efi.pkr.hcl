...
source "qemu" "autogenerated_1" {
  accelerator      = "kvm"
  boot_command     = ["<up>e<wait><down><down><end><bs><bs><bs><bs><bs> text inst.ks=http://{{ .HTTPIP }}:{{ .HTTPPort }}/rocky-kvm-ks.cfg <leftCtrlOn>x<leftCtrlOff><wait>"]
  boot_wait        = "10s"
  ...
  http_port_max    = 10089
  http_port_min    = 10082
  iso_checksum     = "sha256:846d2b6c1d61900038d0647d2f52ff86e6507fd9bcd12a546a600eb9dee1a5fb"
